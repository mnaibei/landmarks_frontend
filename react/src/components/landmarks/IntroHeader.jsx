const IntroHeader = () => (
  <header className="intro-header bg-white text-center mt-16 dark:bg-slate-500">
    <div className=" border-2 border-gray-200 shadow p-4 m-2">
      ...
      <p className="text-sm">
        ...
        <br />
        {' '}
        Africa, a continent of boundless beauty and cultural richness, boasts an
        array of iconic destinations
        {' '}
        <br />
        {' '}
      ...
      <p className="text-sm">
        ...
        <br />
        {' '}
        this curated collection of Africa&apos;s
        finest landmarks invites you to embark on an unforgettable journey of discovery.
      </p>
    </div>
  </header>
);
